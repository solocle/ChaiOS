...
#define BIT_TEST_SET(p, bitn) \
	_bittestandset(p, bitn)

#define BIT_TEST_RESET(p, bitn) \
	_bittestandreset(p, bitn)

#define LOCKED_BIT_TEST_SET(p, bitn) \
	_interlockedbittestandset(p, bitn)

#define LOCKED_BIT_TEST_RESET(p, bitn) \
	_interlockedbittestandreset(p, bitn)
	

typedef volatile long* spinlock_type;
typedef long* unlocked_bittest_type;
...
#define BIT_TEST_SET(p, bitn) \
	_bittestandset64(p, bitn)

#define BIT_TEST_RESET(p, bitn) \
	_bittestandreset64(p, bitn)

#define LOCKED_BIT_TEST_SET(p, bitn) \
	_interlockedbittestandset64(p, bitn)

#define LOCKED_BIT_TEST_RESET(p, bitn) \
	_interlockedbittestandreset64(p, bitn)

typedef volatile int64_t* spinlock_type;
typedef int64_t* unlocked_bittest_type;
